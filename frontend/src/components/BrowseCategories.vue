...
<template>
  <section class="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-14">
    ...
    <div class="text-center mb-10">
      <p class="text-orange-500 text-xs font-black uppercase tracking-widest mb-3">Choose Your Game</p>
      <h2 class="text-2xl md:text-3xl font-black text-gray-900 uppercase tracking-tight mb-2">Browse by Venue Type</h2>
      <p class="text-gray-400 text-sm">Choose your sport and find the perfect venue</p>
    </div>
