<template>
  <footer class="border-t border-gray-100 py-8 px-6 mt-12">
    <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-6 text-xs font-semibold text-gray-400 uppercase tracking-widest">
        ...
        <a href="#" class="hover:text-gray-700 transition-colors">Support Center</a>
      </div>
    </div>
  </footer>
</template>
